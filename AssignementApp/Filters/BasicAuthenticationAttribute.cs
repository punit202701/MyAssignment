...
namespace AssignementApp.Filters
{
    public class BasicAuthenticationAttribute : AuthorizationFilterAttribute
    {
        public override void OnAuthorization(HttpActionContext actionContext)
        {
            ...
            if (authHeader != null)
            {
                ...
                var lstUser = ds.Tables[0].AsEnumerable().Select(dr => new Users { UserName = dr.Field<string>("Name"), Password = dr.Field<string>("Password") }).ToList<Users>();
